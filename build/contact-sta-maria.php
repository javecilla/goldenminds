									    ...
									    <div class="col-md-7">
									      <div class="card-body">
									        <div class="academics_header_text mb-2" >
														<h6 class="card-title">&nbsp;STA.MARIA CAMPUS</h6>
													</div><hr>
													<div class="card-text">
														<p><i class="fas fa-university"></i>&nbsp;SchoolID: <span><b>404468</b></span></p>
									        	<p><i class="fas fa-map-marker"></i>&nbsp;&nbsp;RXC2+HR5, Bypass Rd, Santa Maria, Bulacan</p>
									        	<p><i class="fas fa-phone-alt"></i>&nbsp;&nbsp;(+63) 939 449 9844</p>
									        	<p><i class="fas fa-envelope"></i>&nbsp;&nbsp;gmcstamaria2015@gmail.com</p>
									        </div>
									      </div>
									    </div>
        							<div class="col-md-5">
      									<img src="/public/resources/images/goldenminds.PNG" class="img-fluid rounded-start" />
									    </div>
									  </div>
									</div>
									<div id="gmc_smb_map" class="form-control p-0 mb-2">
										<iframe async src="https://www.google.com/maps/d/embed?mid=1jLZP8sdx-HvR7Gjy8zmTSfOI16wWnqo&ll=14.82128818043957%2C120.9521428636729&z=19" class="card-img-top map"></iframe>
									</div>
							 	</div>
